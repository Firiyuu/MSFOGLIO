<?php 
	...
	$gantt_chart_resources1 = new GanttChart_Resources1();
	...
	if ($api_command === 'get_resources1') {
		$result = $equipment->getResources1(getPOSTValue('category'));
	}
	else if($api_command === 'get_resources') {
		$result = $resources->getResources(getPOSTValue('category'));
	}
	else if ($api_command === 'add_resource1') {
    ...
    } else if ($api_command === 'get_project_chart') {
		$result = $gantt_chart->getProjectChart(getPOSTValue('project_id'));
		...
		$result = $gantt_chart->addActivity(getPOSTValue('date_added'), getPOSTValue('activity'),  getPOSTValue('amount'), getPOSTValue('date_start'), getPOSTValue('date_end'), getPOSTValue('project_id'));
		...
		$result = $gantt_chart_resources->addActivityResources(getPOSTValue('gantt_chart_id'), getPOSTValue('resource_id'), getPOSTValue('quantity'), getPOSTValue('duration'), getPOSTValue('rate'), getPOSTValue('project_id'));
	}else if ($api_command === 'add_activity_resources1') {
		$result = $gantt_chart_resources1->addActivityResources1(getPOSTValue('gantt_chart_id'), getPOSTValue('resource_id'), getPOSTValue('quantity'), getPOSTValue('duration'), getPOSTValue('rate'), getPOSTValue('project_id'));
		...
		$result = $projects->addProject(getPOSTValue('project_name'), getPOSTValue('project_location'),  getPOSTValue('date_added'), getPOSTValue('date_start'), getPOSTValue('duration'), getPOSTValue('date_end'));
	} else if ($api_command === 'delete_project') {
		$result = $projects->deleteProject(getPOSTValue('id'));
	} else if ($api_command === 'update_project') {
		$result = $projects->updateProject(getPOSTValue('id'), getPOSTValue('project_name'), getPOSTValue('project_location'), getPOSTValue('date_added'), getPOSTValue('date_start'), getPOSTValue('duration'), getPOSTValue('date_end'));
		...
		$result = $bill_of_materials->addBillofMaterial(getPOSTValue('project_id'), getPOSTValue('item'), getPOSTValue('quantity'), getPOSTValue('amount'),getPOSTValue('unit'), getPOSTValue('description'), getPOSTValue('total'));
		...
		$result = $bill_of_materials->updateBillofMaterial(getPOSTValue('id'), getPOSTValue('project_id'), getPOSTValue('item'), getPOSTValue('quantity'), getPOSTValue('amount'), getPOSTValue('unit'), getPOSTValue('description'), getPOSTValue('total'));
	...
	} else if ($api_command === 'get_activity_resources1') {
		$result = $gantt_chart_resources1->getActivityResources1(getPOSTValue('gantt_chart_id'));
	 ...
	 else if ($api_command === 'edit_activity_resources1') {
		$result = $gantt_chart_resources1->editActivityResources1(getPOSTValue('id'), getPOSTValue('gantt_chart_id'), getPOSTValue('resource_id'), getPOSTValue('quantity'), getPOSTValue('duration'), getPOSTValue('rate'));
	} 
	...
	else if ($api_command === 'delete_activity_resources1') {
		$result = $gantt_chart_resources1->deleteActivityResources1(getPOSTValue('id'));
	} else if ($api_command === 'get_specific_activity_resources1') {
		$result = $gantt_chart_resources1->getSpecificActivityResources1(getPOSTValue('id'));
	} 

	else if ($api_command === 'get_date_resources1') {
		$result = $gantt_chart_resources1->getDateResources1(getPOSTValue('date'));
	} else if ($api_command === 'get_years') {
		$result = $cashflow->getYears(getPOSTValue('project_id'));
